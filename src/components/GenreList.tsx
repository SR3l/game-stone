...
import { Button, ButtonSpinner, HStack, Heading, Image, List, ListItem, Spinner, Text } from '@chakra-ui/react';
...
const GenreList = ({selectedGenre, onSelectGenre}: Props) => {
  ...
  return (
    <>
    <Heading color='green.300' fontSize='2xl' marginBottom={3}>Geners</Heading>
    <List>
